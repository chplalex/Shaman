...
public class SearchContent {
    ...
    private static SearchItem createSearchItem(int position) {
        return new SearchItem(String.valueOf(position), "Item " + position, makeDetails(position));
    }
    ...
    public static class SearchItem {
        ...
        public SearchItem(String id, String content, String details) {
            this.id = id;
